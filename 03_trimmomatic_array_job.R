...
g_did
q = paste0('select count(File.idSample) as files, Sample.idData, Sample.title, Sample.id as SampleID, Sample.group1 from File, Sample
...
dfQuery
# some samples are not to be processed so they have NA in group1 (treatment)
# variable
