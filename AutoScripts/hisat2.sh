...
# 9. Run the program.
hisat2 --trim5 10 --threads 4 -x /users/k1625253/brc_scratch/Data/MetaData/GenomeIndex/hg38_spikein_hisat2/hg38/genome -1 $inr1 -2 $inr2 -S $outsam
