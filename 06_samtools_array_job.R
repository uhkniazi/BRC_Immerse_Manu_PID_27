...
q = paste0('select File.*, Sample.idData, Sample.group1 as g1 from File, Sample 
           where (Sample.idData = 49) and (File.idSample = Sample.id) and (File.type = "fastq")')
...
cvQueries = paste0('select File.*, Sample.title from File, Sample 
                   where (Sample.idData = 49 and Sample.id =', dfQuery$SampleID, ') and (File.idSample = Sample.id) and 
                   (File.type = "fastq")')
