...
for (i in 1:length(ldfData)){
  ...
  write.csv(dfGreater[,c('p.val', 'q.val', 'set.size')], file=paste('results/hisat2/', cvTitle[i], '_upregulated_pathways_mSigDb_c2_curated.xls', sep=''))
  write.csv(dfLess[,c('p.val', 'q.val', 'set.size')], file=paste('results/hisat2/', cvTitle[i], '_downregulated_pathways_mSigDb_c2_curated.xls', sep=''))
  ...
  write.csv(dfGreater[,c('p.val', 'q.val', 'set.size')], file=paste('results/hisat2/', cvTitle[i], '_upregulated_pathways_mSigDb_c5.xls', sep=''))
  write.csv(dfLess[,c('p.val', 'q.val', 'set.size')], file=paste('results/hisat2/', cvTitle[i], '_downregulated_pathways_mSigDb_c5.xls', sep=''))
}
